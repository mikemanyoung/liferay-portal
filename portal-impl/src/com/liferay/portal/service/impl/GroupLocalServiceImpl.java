...
public class GroupLocalServiceImpl extends GroupLocalServiceBaseImpl {
	...
	/**
	 * Associates a group to the company if none exists.
	 *
	...
	/**
	 * Associates the company with all applicable system groups, creating
	 * necessary system groups if they do not exist.
	 *
	 * @param  companyId the primary key of the company
	 ...
	 *         have permission to delete the group, its assets, or its
	 *         resources
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	/**
	 * Returns the group with the friendly URL, using the finder cache.
	 *
	 * @param  companyId the primary key of the company
	...
	/**
	 * Returns the group with the primary key, using the finder cache.
	 *
	 * @param  groupId the primary key of the group
	...
	/**
	 * Returns the group with the name and associated company, using the finder
	 * cache.
	 *
	 * @param  companyId the primary key of the company
	...
	/**
	 * Returns the group associated with the company.
	 *
	 * @param  companyId the primary key of the company
	...
	/**
	 * Returns the group with the friendly URL.
	 *
	 * @param  companyId the primary key of the company
	 * @param  friendlyURL the group's friendlyURL
	...
	/**
	 * Returns the groups with the primary keys.
	 *
	 * @param  groupIds the primary keys of the groups
	...
	/**
	 * Returns a range of all non-system groups matching the named class that
	 * have no layouts.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end -
	...
	/**
	 * Returns the group associated with the organization.
	 *
	 * @param  companyId the primary key of the company
	...
	/**
	 * Returns the group associated with the user group.
	 *
	 * @param  companyId the primary key of the company
