...
public class PropsValues {
	...
	public static final boolean PORTLET_SETUP_LINK_TO_LAYOUT_RENDER_PHASE_ONLY = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.PORTLET_SETUP_LINK_TO_LAYOUT_RENDER_PHASE_ONLY));
