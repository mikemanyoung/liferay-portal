...
public class DLSyncEventPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newDLSyncEvent.setTypeId(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingDLSyncEvent.getTypeId(),
			newDLSyncEvent.getTypeId());
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("DLSyncEvent",
			"syncEventId", true, "modifiedDate", true, "typeId", true, "type",
			true, "event", true);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(existingDLSyncEventModelImpl.getTypeId(),
			existingDLSyncEventModelImpl.getOriginalTypeId());
	}
	...
	protected DLSyncEvent addDLSyncEvent() throws Exception {
		...
		dlSyncEvent.setTypeId(ServiceTestUtil.nextLong());
