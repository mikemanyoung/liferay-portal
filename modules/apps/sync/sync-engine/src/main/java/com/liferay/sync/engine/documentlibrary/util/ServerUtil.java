...
public class ServerUtil {
	...
	public static String fixUrlPath(
	...
	public static String fixUrlPath(long syncAccountId, String urlPath) {
		return fixUrlPath(
			ServerInfo.supportsModuleFramework(syncAccountId), urlPath);
	}

	public static String fixUrlPath(String pluginVersion, String urlPath) {
		return fixUrlPath(
