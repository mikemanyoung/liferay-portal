...
public class DLSyncEventWrapper implements DLSyncEvent,
	...
	*/
	...
	/**
	* Returns the type ID of this d l sync event.
	*
	* @return the type ID of this d l sync event
	*/
	@Override
	public long getTypeId() {
		return _dlSyncEvent.getTypeId();
	}

	/**
	* Sets the type ID of this d l sync event.
	*
	* @param typeId the type ID of this d l sync event
	*/
	@Override
	public void setTypeId(long typeId) {
		_dlSyncEvent.setTypeId(typeId);
	}
